...
function sendNumberValue(number) {
    ...
    if (isWaiting) {
        ...
        let displayValue = calculatorTitle.textContent;
...
function useOperator(operator) {
    ...
    if (!initialValue) {
        ...
        console.log(`initial value ${initialValue} , currentValue ${currentValue}`);

        let calculation = calc[operatorValue](initialValue, currentValue)
