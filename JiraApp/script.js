...
function filterArray(array) {
    const filtredArray = array.filter((item) => item !== null);
    return filtredArray
}
...
function showItemDiv(column) {
    ...
    addItemContainers[column].style.display = 'block';
    saveButtons[column].style.display = 'block';
}
...
function addToColumn(column) {
    ...
    const selectedArray = listArrays[column];
    selectedArray.push(addItems[column].textContent);
